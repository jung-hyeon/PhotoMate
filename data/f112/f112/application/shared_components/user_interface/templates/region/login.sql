...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18003134640431695)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18003496649431695)
,p_plug_template_id=>wwv_flow_api.id(18003134640431695)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18003790759431695)
,p_plug_template_id=>wwv_flow_api.id(18003134640431695)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18004013934431695)
,p_plug_template_id=>wwv_flow_api.id(18003134640431695)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18004355027431696)
,p_plug_template_id=>wwv_flow_api.id(18003134640431695)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18004612608431696)
,p_plug_template_id=>wwv_flow_api.id(18003134640431695)
,p_name=>'Sub Regions'
