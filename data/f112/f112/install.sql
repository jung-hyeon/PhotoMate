...
@@application/shared_components/files/photomate_logo_png.sql
@@application/shared_components/files/app_112_logo_png.sql
@@application/shared_components/files/app_112_logo_jpg.sql
@@application/shared_components/files/photomate_logo_jpg.sql
@@application/shared_components/files/small_logo_png.sql
...
@@application/shared_components/logic/application_processes/add_user_002.sql
...
@@application/shared_components/logic/application_items/shopping_cart_item.sql
@@application/shared_components/logic/application_items/user_id.sql
@@application/shared_components/logic/application_items/wishlist_icon.sql
@@application/shared_components/logic/application_items/wishlist_items.sql
@@application/shared_components/logic/application_settings.sql
@@application/shared_components/navigation/tabs/standard.sql
@@application/shared_components/navigation/tabs/parent.sql
@@application/shared_components/user_interface/lovs/film_types_film_types_name.sql
...
@@application/shared_components/user_interface/lovs/public.sql
@@application/shared_components/user_interface/lovs/studio_list.sql
@@application/shared_components/user_interface/lovs/studio_first_address.sql
@@application/shared_components/user_interface/lovs/studio_images_imgpath1.sql
@@application/shared_components/user_interface/lovs/studio_images_imgpath2.sql
@@application/shared_components/user_interface/lovs/studio_images_imgpath3.sql
@@application/shared_components/user_interface/lovs/studio_images_imgpath4.sql
@@application/shared_components/user_interface/lovs/studio_images_imgpath5.sql
@@application/shared_components/user_interface/lovs/studio_images_imgpath6.sql
@@application/shared_components/user_interface/lovs/studio_images_imgpath7.sql
@@application/shared_components/user_interface/lovs/studio_keywords_studio_keywords_name.sql
@@application/shared_components/user_interface/lovs/studio_second_address.sql
@@application/shared_components/user_interface/lovs/wishlist_studio_name.sql
...
@@application/shared_components/security/authentications/custom_p_user.sql
