...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18001371599431694)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18001683977431694)
,p_plug_template_id=>wwv_flow_api.id(18001371599431694)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18001993085431695)
,p_plug_template_id=>wwv_flow_api.id(18001371599431694)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18002231339431695)
,p_plug_template_id=>wwv_flow_api.id(18001371599431694)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18002519453431695)
,p_plug_template_id=>wwv_flow_api.id(18001371599431694)
,p_name=>'Sub Regions'
