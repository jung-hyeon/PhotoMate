prompt --application/shared_components/user_interface/lovs/studio_second_address
begin
--   Manifest
--     STUDIO_SECOND_ADDRESS
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(18131783450490599)
,p_lov_name=>'STUDIO_SECOND_ADDRESS'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
