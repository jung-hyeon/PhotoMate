...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20750116617301836)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20750467302301836)
,p_plug_template_id=>wwv_flow_api.id(20750116617301836)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20750772892301836)
,p_plug_template_id=>wwv_flow_api.id(20750116617301836)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20751064044301836)
,p_plug_template_id=>wwv_flow_api.id(20750116617301836)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20751319219301836)
,p_plug_template_id=>wwv_flow_api.id(20750116617301836)
,p_name=>'Sub Regions'
