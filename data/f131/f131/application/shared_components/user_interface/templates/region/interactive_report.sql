...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(40310864640637723)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40311137609637723)
,p_plug_template_id=>wwv_flow_api.id(40310864640637723)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40311401626637723)
,p_plug_template_id=>wwv_flow_api.id(40310864640637723)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40311684970637723)
,p_plug_template_id=>wwv_flow_api.id(40310864640637723)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40312000519637723)
,p_plug_template_id=>wwv_flow_api.id(40310864640637723)
,p_name=>'Sub Regions'
