...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20728168402301824)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728450911301824)
,p_plug_template_id=>wwv_flow_api.id(20728168402301824)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728770966301824)
,p_plug_template_id=>wwv_flow_api.id(20728168402301824)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729017178301824)
,p_plug_template_id=>wwv_flow_api.id(20728168402301824)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729368397301824)
,p_plug_template_id=>wwv_flow_api.id(20728168402301824)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729653293301824)
,p_plug_template_id=>wwv_flow_api.id(20728168402301824)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729976108301824)
,p_plug_template_id=>wwv_flow_api.id(20728168402301824)
,p_name=>'Sub Regions'
