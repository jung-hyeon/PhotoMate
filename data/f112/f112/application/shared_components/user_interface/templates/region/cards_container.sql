...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17958363523431674)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17958642376431674)
,p_plug_template_id=>wwv_flow_api.id(17958363523431674)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17958927057431675)
,p_plug_template_id=>wwv_flow_api.id(17958363523431674)
,p_name=>'Sub Regions'
