...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(40300836105637719)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40301088896637719)
,p_plug_template_id=>wwv_flow_api.id(40300836105637719)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40301463849637719)
,p_plug_template_id=>wwv_flow_api.id(40300836105637719)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40301756902637719)
,p_plug_template_id=>wwv_flow_api.id(40300836105637719)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40302014006637719)
,p_plug_template_id=>wwv_flow_api.id(40300836105637719)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40302320293637719)
,p_plug_template_id=>wwv_flow_api.id(40300836105637719)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40302607139637719)
,p_plug_template_id=>wwv_flow_api.id(40300836105637719)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40302890602637719)
,p_plug_template_id=>wwv_flow_api.id(40300836105637719)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40303246946637720)
,p_plug_template_id=>wwv_flow_api.id(40300836105637719)
,p_name=>'Sub Regions'
