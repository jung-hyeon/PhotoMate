...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17983508532431686)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17983822868431686)
,p_plug_template_id=>wwv_flow_api.id(17983508532431686)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17984142691431686)
,p_plug_template_id=>wwv_flow_api.id(17983508532431686)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17984409261431686)
,p_plug_template_id=>wwv_flow_api.id(17983508532431686)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17984769932431686)
,p_plug_template_id=>wwv_flow_api.id(17983508532431686)
,p_name=>'Sub Regions'
