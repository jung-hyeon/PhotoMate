...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(40255509902637695)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40255875153637697)
,p_plug_template_id=>wwv_flow_api.id(40255509902637695)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40256081945637697)
,p_plug_template_id=>wwv_flow_api.id(40255509902637695)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40256410585637697)
,p_plug_template_id=>wwv_flow_api.id(40255509902637695)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40256724552637697)
,p_plug_template_id=>wwv_flow_api.id(40255509902637695)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40257000370637698)
,p_plug_template_id=>wwv_flow_api.id(40255509902637695)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40257370884637698)
,p_plug_template_id=>wwv_flow_api.id(40255509902637695)
,p_name=>'Sub Regions'
