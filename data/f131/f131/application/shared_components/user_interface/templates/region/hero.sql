...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(40292984446637715)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40293281509637715)
,p_plug_template_id=>wwv_flow_api.id(40292984446637715)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40293613435637716)
,p_plug_template_id=>wwv_flow_api.id(40292984446637715)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40293887079637716)
,p_plug_template_id=>wwv_flow_api.id(40292984446637715)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40294229826637716)
,p_plug_template_id=>wwv_flow_api.id(40292984446637715)
,p_name=>'Sub Regions'
