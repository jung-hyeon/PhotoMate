...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17979381168431684)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17979681903431684)
,p_plug_template_id=>wwv_flow_api.id(17979381168431684)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17979900113431684)
,p_plug_template_id=>wwv_flow_api.id(17979381168431684)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17980249351431684)
,p_plug_template_id=>wwv_flow_api.id(17979381168431684)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17980598388431684)
,p_plug_template_id=>wwv_flow_api.id(17979381168431684)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17980823255431684)
,p_plug_template_id=>wwv_flow_api.id(17979381168431684)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17981132755431685)
,p_plug_template_id=>wwv_flow_api.id(17979381168431684)
,p_name=>'Sub Regions'
