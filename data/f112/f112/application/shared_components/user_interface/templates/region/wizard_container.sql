...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18022535180431704)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18022862850431705)
,p_plug_template_id=>wwv_flow_api.id(18022535180431704)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18023160220431705)
,p_plug_template_id=>wwv_flow_api.id(18022535180431704)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18023451099431705)
,p_plug_template_id=>wwv_flow_api.id(18022535180431704)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18023790714431705)
,p_plug_template_id=>wwv_flow_api.id(18022535180431704)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18024062551431705)
,p_plug_template_id=>wwv_flow_api.id(18022535180431704)
