...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20732349551301826)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732665041301826)
,p_plug_template_id=>wwv_flow_api.id(20732349551301826)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732934004301826)
,p_plug_template_id=>wwv_flow_api.id(20732349551301826)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20733268858301826)
,p_plug_template_id=>wwv_flow_api.id(20732349551301826)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20733596637301826)
,p_plug_template_id=>wwv_flow_api.id(20732349551301826)
,p_name=>'Sub Regions'
