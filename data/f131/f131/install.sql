...
@@application/shared_components/files/oracle_apex_webp.sql
@@application/shared_components/files/bg_png.sql
@@application/shared_components/files/photomate_logo_jpg.sql
@@application/shared_components/files/app_105_logo_jpg.sql
...
@@application/shared_components/user_interface/lovs/studio_types.sql
@@application/shared_components/user_interface/lovs/film_types.sql
@@application/shared_components/user_interface/lovs/first_address.sql
@@application/shared_components/user_interface/lovs/login_remember_username.sql
@@application/shared_components/user_interface/lovs/second_address.sql
@@application/shared_components/user_interface/lovs/studio_keywords.sql
