...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20771385723301846)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20771661982301846)
,p_plug_template_id=>wwv_flow_api.id(20771385723301846)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20771983954301846)
,p_plug_template_id=>wwv_flow_api.id(20771385723301846)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20772216731301846)
,p_plug_template_id=>wwv_flow_api.id(20771385723301846)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20772553580301846)
,p_plug_template_id=>wwv_flow_api.id(20771385723301846)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20772805815301846)
,p_plug_template_id=>wwv_flow_api.id(20771385723301846)
