...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20751997887301837)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20752222895301837)
,p_plug_template_id=>wwv_flow_api.id(20751997887301837)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20752596082301837)
,p_plug_template_id=>wwv_flow_api.id(20751997887301837)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20752861523301837)
,p_plug_template_id=>wwv_flow_api.id(20751997887301837)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20753171892301837)
,p_plug_template_id=>wwv_flow_api.id(20751997887301837)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20753446693301837)
,p_plug_template_id=>wwv_flow_api.id(20751997887301837)
,p_name=>'Sub Regions'
