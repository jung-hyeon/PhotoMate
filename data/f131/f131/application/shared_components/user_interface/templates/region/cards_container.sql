...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(40267814759637703)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40268143499637703)
,p_plug_template_id=>wwv_flow_api.id(40267814759637703)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40268418171637703)
,p_plug_template_id=>wwv_flow_api.id(40267814759637703)
,p_name=>'Sub Regions'
