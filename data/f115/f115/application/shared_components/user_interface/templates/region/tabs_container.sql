...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20763997471301843)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20764214552301843)
,p_plug_template_id=>wwv_flow_api.id(20763997471301843)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20764585464301843)
,p_plug_template_id=>wwv_flow_api.id(20763997471301843)
,p_name=>'Tabs'
