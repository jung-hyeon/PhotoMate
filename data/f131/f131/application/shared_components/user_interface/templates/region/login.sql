...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(40312603326637724)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40312898359637724)
,p_plug_template_id=>wwv_flow_api.id(40312603326637724)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40313253370637724)
,p_plug_template_id=>wwv_flow_api.id(40312603326637724)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40313505960637724)
,p_plug_template_id=>wwv_flow_api.id(40312603326637724)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40313870129637724)
,p_plug_template_id=>wwv_flow_api.id(40312603326637724)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40314106114637724)
,p_plug_template_id=>wwv_flow_api.id(40312603326637724)
,p_name=>'Sub Regions'
