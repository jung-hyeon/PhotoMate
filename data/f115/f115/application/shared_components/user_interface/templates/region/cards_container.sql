...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20707117160301812)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20707437356301812)
,p_plug_template_id=>wwv_flow_api.id(20707117160301812)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20707750342301812)
,p_plug_template_id=>wwv_flow_api.id(20707117160301812)
,p_name=>'Sub Regions'
