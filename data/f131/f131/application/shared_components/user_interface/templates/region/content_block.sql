...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(40288834670637713)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40289137076637714)
,p_plug_template_id=>wwv_flow_api.id(40288834670637713)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40289424492637714)
,p_plug_template_id=>wwv_flow_api.id(40288834670637713)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40289769022637714)
,p_plug_template_id=>wwv_flow_api.id(40288834670637713)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40289994073637714)
,p_plug_template_id=>wwv_flow_api.id(40288834670637713)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40290336149637714)
,p_plug_template_id=>wwv_flow_api.id(40288834670637713)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40290642628637714)
,p_plug_template_id=>wwv_flow_api.id(40288834670637713)
,p_name=>'Sub Regions'
