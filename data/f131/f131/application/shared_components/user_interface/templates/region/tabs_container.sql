...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(40324586693637729)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40324978272637730)
,p_plug_template_id=>wwv_flow_api.id(40324586693637729)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(40325181750637730)
,p_plug_template_id=>wwv_flow_api.id(40324586693637729)
,p_name=>'Tabs'
