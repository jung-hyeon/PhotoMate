prompt --application/shared_components/user_interface/lovs/film_types_film_types_name
begin
--   Manifest
--     FILM_TYPES.FILM_TYPES_NAME
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(18132133342495304)
,p_lov_name=>'FILM_TYPES.FILM_TYPES_NAME'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
