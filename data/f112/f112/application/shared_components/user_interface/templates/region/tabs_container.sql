...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18015118030431701)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18015449582431701)
,p_plug_template_id=>wwv_flow_api.id(18015118030431701)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18015748544431701)
,p_plug_template_id=>wwv_flow_api.id(18015118030431701)
,p_name=>'Tabs'
